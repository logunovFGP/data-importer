                    ...
                    <div class="col-sm-9">
                        <div class="form-check">
                            <input class="form-check-input"
                                   <?php if($configuration->isSkipForm()): ?> checked <?php endif; ?>
                                   type="checkbox"
...
<?php /**PATH /var/www/html/resources/views/v2/import/004-configure/partials/import-options.blade.php ENDPATH**/ ?>