<?php if(0 === count($applicationAccounts['assets']) && 0 === count($applicationAccounts['liabilities']) && $flow === 'file'): ?>
    <div class="row mt-3">
...
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/v2/import/004-configure/partials/no-account-warning.blade.php ENDPATH**/ ?>