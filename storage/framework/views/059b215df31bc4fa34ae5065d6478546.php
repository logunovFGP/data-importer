 ...
 */
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['src/sass/app.scss']); ?>



    <title>Firefly III Data Importer // <?php echo e($pageTitle ?? 'No title'); ?></title>
</head>
<body>
<?php if(config('importer.is_external')): ?>
...
<?php if('' != config('importer.tracker_site_id') and '' != config('importer.tracker_url')): ?>
<!-- Matomo -->
<script>
    ...
    (function () {
        var u = "<?php echo e(config('importer.tracker_url')); ?>";
        _paq.push(['setTrackerUrl', u + 'matomo.php']);
        _paq.push(['setSiteId', '<?php echo e(config('importer.tracker_site_id')); ?>']);
...
<noscript><p><img src="<?php echo e(config('importer.tracker_url')); ?>matomo.php?idsite=<?php echo e(config('importer.tracker_site_id')); ?>&amp;rec=1" style="border:0;" alt=""/>
    </p></noscript>
<!-- End Matomo Code -->
<?php endif; ?>
<script>
...
window.updateDuplicateStatus = function(accountId) {
    try {
        ...
        fetch('./check-duplicate-account/<?php echo e($identifier ?? ''); ?>', {
            method: 'POST',
            headers: {
...
<?php /**PATH /var/www/html/resources/views/v2/layout/v2.blade.php ENDPATH**/ ?>