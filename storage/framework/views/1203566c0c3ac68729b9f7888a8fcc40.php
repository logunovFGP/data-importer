                    ...
                    <div class="col-sm-9">
                        <div class="form-check">
                            <input class="form-check-input date-range-radio" id="date_range_all"
                                   ...
                                   <?php if('all' === $configuration->getDateRange()): ?> checked <?php endif; ?>
                        ...
                        <div class="form-check">
                            <input class="form-check-input date-range-radio" id="date_range_partial"
                                   ...
                                   value="partial"
                                   <?php if('partial' === $configuration->getDateRange()): ?> checked <?php endif; ?>
                                   aria-describedby="rangeHelp"/>
                        ...
                        <div class="form-check">
                            <input class="form-check-input date-range-radio" id="date_range_range"
                                   ...
                                   <?php if('range' === $configuration->getDateRange()): ?> checked <?php endif; ?>
                                   aria-describedby="rangeHelp"/>
                ...
                <div class="form-group row mb-3" id="date_range_partial_settings_one" x-show="'partial' === dateRange">
                    ...
                    <div class="col-sm-3">
                        <input
                            ...
                            class="form-control" value="<?php echo e($configuration->getDateRangeNumber()); ?>"
                    ...
                    <div class="col-sm-6">
                        <select class="form-control"
                                ...
                                id="date_range_unit">
                            <option
                                <?php if('d' === $configuration->getDateRangeUnit()): ?> selected <?php endif; ?>
                            value="d" label="days">days
                            </option>
                            <option
                                <?php if('w' === $configuration->getDateRangeUnit()): ?> selected <?php endif; ?>
                            value="w" label="weeks">weeks
                            </option>
                            <option
                                <?php if('m' === $configuration->getDateRangeUnit()): ?> selected <?php endif; ?>
                            value="m" label="months">months
                            </option>
                            <option
                                <?php if('y' === $configuration->getDateRangeUnit()): ?> selected <?php endif; ?>
                ...
                <div class="form-group row mb-3" id="date_range_partial_settings_two" x-show="'partial' === dateRange">
                    ...
                    <div class="col-sm-3">
                        <input
                            ...
                            class="form-control" value="<?php echo e($configuration->getDateRangeNotAfterNumber()); ?>"
                    ...
                    <div class="col-sm-6">
                        <select class="form-control"
                            ...
                            <option
                                <?php if('' === $configuration->getDateRangeNotAfterUnit()): ?> selected <?php endif; ?>
                            value="" label="(import all transactions)">(import all transactions)
                            </option>
                            <option
                                <?php if('d' === $configuration->getDateRangeNotAfterUnit()): ?> selected <?php endif; ?>
                            value="d" label="days ago">days ago
                            </option>
                            <option
                                <?php if('w' === $configuration->getDateRangeNotAfterUnit()): ?> selected <?php endif; ?>
                            value="w" label="weeks ago">weeks ago
                            </option>
                            <option
                                <?php if('m' === $configuration->getDateRangeNotAfterUnit()): ?> selected <?php endif; ?>
                            value="m" label="months ago">months ago
                            </option>
                            <option
                                <?php if('y' === $configuration->getDateRangeNotAfterUnit()): ?> selected <?php endif; ?>
                ...
                <div class="form-group row mb-3" id="date_range_range_settings" x-show="'range' === dateRange">
                    ...
                    <div class="col-sm-4">
                        <input type="date" name="date_not_before" class="form-control"
                               value="<?php echo e($configuration->getDateNotBefore()); ?>">
                    </div>
                    <div class="col-sm-4">
                        <input type="date" name="date_not_after" class="form-control"
                               value="<?php echo e($configuration->getDateNotAfter()); ?>">
                    </div>
                </div>

                <?php if('basisbank' === $flow || 'tbank' === $flow || 'trc20' === $flow): ?>
                        ...
                        <div class="col-sm-9">
                            <div class="form-check">
                                ...
                                <input
                                    ...
                                    <?php if($configuration->isIncrementalSyncEnabled()): ?> checked <?php endif; ?>
                                >
                            ...
                            <div class="mt-2">
                                ...
                                <input
                                    ...
                                    min="0"
                                    max="365"
                                    value="<?php echo e($configuration->getIncrementalLookbackDays()); ?>">
                                <div class="form-text text-muted">
...
<?php /**PATH /var/www/html/resources/views/v2/import/004-configure/partials/data-importer-dates.blade.php ENDPATH**/ ?>