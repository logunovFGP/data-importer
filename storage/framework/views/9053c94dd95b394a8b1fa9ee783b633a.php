                        ...
                        <div class="col-sm-9">
                            <div class="form-check">
                                <input class="form-check-input"
                                       <?php if($configuration->isIgnoreDuplicateLines()): ?> checked <?php endif; ?>
                    ...
                    <div class="col-sm-9">
                        <select id="duplicate_detection_method" name="duplicate_detection_method" x-model="detectionMethod"
                            ...
                            <option label="No duplicate detection"
                                    <?php if('none' === $configuration->getDuplicateDetectionMethod()): ?> selected <?php endif; ?>
                                    value="none">No duplicate detection
                            </option>
                            <option label="Content-based"
                                    <?php if('classic' === $configuration->getDuplicateDetectionMethod()): ?> selected <?php endif; ?>
                                    value="classic">Content-based detection
                            </option>
                            <option label="Identifier-based"
                                    <?php if('cell' === $configuration->getDuplicateDetectionMethod()): ?> selected <?php endif; ?>
                    ...
                    <div class="form-group row mb-3" id="unique_column_index_holder" x-show="'cell' === detectionMethod">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="unique_column_index" class="form-control"
                                   ...
                                   value="<?php echo e($configuration->getUniqueColumnIndexDisplay()); ?>"
                ...
                <div class="form-group row" id="unique_column_type_holder" x-show="'cell' === detectionMethod">
                    ...
                    <div class="col-sm-9">
                        <select id="unique_column_type" name="unique_column_type" class="form-control"
                            ...
                            <?php $__currentLoopData = $uniqueColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $columnType => $columnName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option label="<?php echo e($columnName); ?>"
                                        <?php if($configuration->getUniqueColumnType() === $columnType): ?> selected <?php endif; ?>
                                        value="<?php echo e($columnType); ?>"><?php echo e($columnName); ?></option>
...
<?php /**PATH /var/www/html/resources/views/v2/import/004-configure/partials/duplicate-detection-options.blade.php ENDPATH**/ ?>